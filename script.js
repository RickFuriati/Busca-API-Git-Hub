...
document.onload
    fetch("https://api.github.com/users/rickfuriati") 
    ...
    .then((data) =>{
        ...
        `
        document.getElementById("link").href="https://github.com/rickfuriati"
           
    })   
    fetch(`https://api.github.com/users/rickfuriati/repos`)
